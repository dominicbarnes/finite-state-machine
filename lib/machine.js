...
/**
 * Get/set the current state of the machine, also updates the previous state
 * of the machine.
 *
 * @param {String|State} state
 * @returns {Machine}
...
Machine.prototype.handle = function (event) {
    ...
    this.getState(this._currentState).runHandler(this, event, args);
    return this;
};
...
Machine.prototype.transition = function (state) {
    if (this._currentState) {
        ...
        this.getState(this._currentState).runHandler(this, "_exit");
    }

    debug("entering " + state + " state");
    this.currentState(state);
    this.getState(this._currentState).runHandler(this, "_enter");
    return this;
};
